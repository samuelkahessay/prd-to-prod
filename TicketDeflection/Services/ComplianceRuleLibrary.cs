...
public sealed class ComplianceRuleLibrary : IComplianceRuleLibrary
{
    ...
    [
        ...
        new(
            ...
            "PIPEDA privacy and safeguards obligations",
        ...
        new(
            ...
            ComplianceRegulation.PIPEDA,
            "PIPEDA financial data handling obligations",
        ...
        new(
            ...
            ComplianceRegulation.PIPEDA,
            "PIPEDA sensitive data handling obligations",
            "Personal Identifiers",
            FindingSeverity.High,
            ComplianceDisposition.HUMAN_REQUIRED,
        ...
        new(
            ...
            ComplianceRegulation.PIPEDA,
            "PIPEDA personal data handling obligations",
            "Personal Identifiers",
            FindingSeverity.Medium,
        ...
        new(
            ...
            ComplianceRegulation.PIPEDA,
            "PIPEDA health data handling obligations",
            "Health Information",
            FindingSeverity.Critical,
            ComplianceDisposition.AUTO_BLOCK,
        ...
        new(
            ...
            "PCMLTFA large transaction reporting obligations",
        ...
        new(
            ...
            ComplianceRegulation.FINTRAC,
            "PCMLTFA suspicious transaction reporting obligations",
        ...
        new(
            ...
            ComplianceRegulation.FINTRAC,
            "PCMLTFA identity verification obligations",
        ...
        new(
            ...
            ComplianceRegulation.FINTRAC,
            "PCMLTFA record-keeping obligations",
            "Record Keeping",
            FindingSeverity.Medium,
            ComplianceDisposition.ADVISORY,
        ...
        new(
            ...
            ComplianceRegulation.FINTRAC,
            "PCMLTFA cash transaction reporting obligations",
            "Transaction Reporting",
            FindingSeverity.High,
            ComplianceDisposition.HUMAN_REQUIRED,
        ...
        new(
            ...
            ComplianceRegulation.FINTRAC,
            "PCMLTFA AML program obligations",
            "AML Controls",
            FindingSeverity.Critical,
            ComplianceDisposition.AUTO_BLOCK,
        ...
        new(
            ...
            ComplianceRegulation.FINTRAC,
            "PCMLTFA transaction reporting controls",
            "Transaction Reporting",
            FindingSeverity.Medium,
            ComplianceDisposition.ADVISORY,
